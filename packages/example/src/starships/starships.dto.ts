...
export class StarshipDto extends createZodDto(
  z
    .object({
      id: z
        .number()
        .int()
        .positive()
        .describe('Unique identifier for the starship'),
      name: z
        .string()
...
export class CreateStarshipFormDto extends createZodDto(
  StarshipDto.schema.omit({ id: true }).meta({ id: 'CreateStarshipForm' }),
) {}

export class StarshipListDto extends createZodDto(
  z
    .object({
