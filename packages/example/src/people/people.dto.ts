...
export class PersonDto extends createZodDto(
  z
    .object({
      id: z
        .number()
        .int()
        .positive()
        .describe('Unique identifier for the person'),
...
export class CreatePersonFormDto extends createZodDto(
  PersonDto.schema
    ...
    .meta({ id: 'CreatePersonFormDto' }),
  {
    codec: true,
  },
) {}

export class PersonListDto extends createZodDto(
  z
    .object({
...
export class GetPersonResponse extends createZodDto(
  z.object({ data: PersonDto.schema }),
  { codec: true },
) {}

export class PersonFilterDto extends createZodDto(
  z.object({
    filter: z
      .object({
...
export class GetPersonParams extends createZodDto(
  z.object({ id: z.string().transform((val) => parseInt(val)) }),
) {}
